      ...
      (e = {
        ...
        showProducts: function (s) {
          ...
          let m = t("<div>")
              ...
              .html(`Загальна сума / ${a.smartBasketCurrency}`),
            k = t("<div>")
              .attr({ class: "smart-basket__product-delete" })
              .text("");
        ...
        stateBasket: function () {
          ...
          } else console.log("Заповніть параметри productSize и productPrice");
          return (
        ...
        commonResult: function (e, s, r) {
          let n = 0,
            ...
            o = t("<div>")
              ...
              .text("У кошику немає жодного товару")
              .fadeOut(),
            l = t("<div>")
              .attr({ class: "smart-basket__success-title" })
              .text("Ваше замовлення прийнято. Очікуйте на дзвінок")
              .css("display", "none"),
          ...
          if ((0 == +n ? o.fadeIn() : o.fadeOut(), r))
            ...
            if (!s)
              return (
                d.html(`<span>Всього товарів: </span> ${n}`),
                p.html(
                  `<span>Загальна сума: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(
                    2
            ...
            0 == +n && t("." + o.attr("class")).css("display", "block"),
              t("." + d.attr("class")).html("<span>Загальна сума: </span> "),
              t("." + d.attr("class")).html(
                `<span>Загальна сума: </span> ${n}`
              ),
              t("." + p.attr("class")).html("<span>Загальна сума: </span> "),
              t("." + p.attr("class")).html(
                `<span>Загальна сума: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(
                  2
                )} ${a.smartBasketCurrency}">`
          ...
          if ((c.append(p), a.agreement.isRequired)) {
            ...
            let e = t("<label>").attr({
              ...
              s = t("<input>").attr({
                ...
                value: "Я погоджуюсь на обробку данних",
              }),
              r = null;
            (r = a.agreement.isLink
              ...
              s.is(":checked")
                ? r.text("Я погоджуюсь на обробку данних")
                : r.text("Я не погоджуюсь на обробку данних"),
              e.click(function () {
                s.is(":checked")
                  ? (r.text("Я не погоджуюсь на обробку данних"),
                    s.val("Я не погоджуюсь на обробку данних"),
                    m.attr({ disabled: "disabled" }),
                    d.addClass("smart-basket__input-wrapper_error"))
                  : (r.text("Я погоджуюсь на обробку данних"),
                    s.val("Я погоджуюсь на обробку данних"),
                    m.attr({ disabled: !1 }),
